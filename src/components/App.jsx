...
const filteredContact = this.state.contacts.filter ((contact) => contact.name.includes(this.state.filter));
...
<h1>Phonebook</h1>
  ...
  <h2>Contacts</h2>
  <Filter contactsArray={this.state.contacts} handlerChangeFilter={this.handlerChangeFilter}/>
  <ContactList contactsArray={filteredContact} contactBtnDeleter={this.contactBtnDeleter}/>
